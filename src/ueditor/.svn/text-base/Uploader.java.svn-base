...
public class Uploader {
	...
	public void upload() throws Exception {
		...
		String savePath = this.getFolder(this.savePath);//实际地址
...
//					this.url = savePath + "/" + this.fileName;
	...
	private String getName(String fileName) {
		return this.fileName = GuidUtil.newGuid()+this.getFileExt(fileName);
...
//				+ System.currentTimeMillis() + this.getFileExt(fileName);
	...
	private String getPhysicalPath(String path) {
		return AttachmentUtil.getUploadFilePath()+"/"+path;
	...
	public void downByPath(HttpServletRequest request, HttpServletResponse response){
		...
		if (filePath != null) {
			try {
				...
				String baseDir = AttachmentUtil.getUploadFilePath();
