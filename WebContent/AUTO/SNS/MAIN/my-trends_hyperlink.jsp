...
<html>
	<head>
		...
		<title>修车人-会员中心-个人链接</title>
		<%@include file="../include/autoSNSBaseInclude.jsp" %>
		
	</head>
	<body>
		<form id="snsCoreForm">
		<c:set var="hyperlinkList" value="${hyperlinkList}"></c:set>
			...
			<div class="mc-middle-layout fl">
				...
				<div class="ask-title mt20">
					...
					<a class="title-name" href="javascript:showtopic();"> 话题 (10) <span
						class="gong-red"></span> </a>
					<a class="title-name cur" href="javascript:showhyperlink();"> 链接 (10) <span
						class="gong-red"></span> </a>
					<div class="cb"></div>
				</div>
				<c:forEach var="hyperlink" items="${hyperlinkList}">
						...
						<div class="fl ml10">
							<div class="f14 ellipsis w480">
								<label class="blue-color fb f14">
									${hyperlink.pubUserName}：
								</label>
								${hyperlink.schyTitle}
							</div>
							<div class="mt5 gray-color">
								连接地址：<a href="http://${hyperlink.schyHref}">${hyperlink.schyHref}</a>
							</div>
							<div class="ask-details mt5">
								...
								<div class="fr">
									<label class="mr15">
										<a href="javascript:void(0);" class="blue-front">回复(${hyperlink.replyNum})</a>
									</label>
									|
									<label class="ml15 mr15">
										<a href="javascript:void(0);" class="blue-front">推荐(${hyperlink.recommendNum})</a>
									</label>
									|
									<label class="ml15 mr15">
										<a href="javascript:void(0);" class="blue-front">收藏(${hyperlink.favoriteNum})</a>
									</label>
									|
									<label class="ml15">
