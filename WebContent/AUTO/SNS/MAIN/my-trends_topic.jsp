...
<html>
	<head>
		...
		<title>修车人-会员中心-个人话题</title>
		<%@include file="../include/autoSNSBaseInclude.jsp" %>
		
	</head>
	<body>
		<form id="snsCoreForm">
		<c:set var="topicList" value="${topicList}"></c:set>
			...
			<div class="mc-middle-layout fl">
				...
				<div class="ask-title mt20">
					...
					<a class="title-name" href="javascript:showvote();"> 投票 (10) <span
						class="gong-red"></span> </a>
					<a class="title-name cur" href="javascript:showtopic();"> 话题 (10) <span
						class="gong-red"></span> </a>
					...
					<div class="other-content">
						...
						<div class="fl ml10">
							...
							<div class="ask-details mt5">
								...
								<div class="fr">
									<label class="mr15">
										<a href="javascript:reply(${topic.sctoGuid});" class="blue-front">回复(${topic.replyNum})</a>
									</label>
									|
									<label class="ml15 mr15">
										<a href="javascript:void(0);" class="blue-front">推荐(${topic.recommendNum})</a>
									</label>
									|
									<label class="ml15 mr15">
										<a href="javascript:void(0);" class="blue-front">收藏(${topic.favoriteNum})</a>
									</label>
									|
									<label class="ml15">
