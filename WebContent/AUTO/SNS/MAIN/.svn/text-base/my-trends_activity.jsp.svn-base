		...
		<div class="member-center">
			...
			<div class="mc-middle-layout fl">
				...
				<div class="ask-title mt20">
					...
					<a class="title-name cur" href="javascript:showactivity();"> 活动 (10) <span
						class="gong-red"></span> </a>
				...
				<c:forEach var="activity" items="${activityList}">
					<div class="other-content">
						<div class="fl">
							<img src="${ctx}/AUTO/SNS/static/images/xcr/user-photo.png" width="60px" height="60px" />
						</div>
						<div class="fl ml10">
							<div class="f14 ellipsis w480">
								<label class="blue-color fb f14">
									${activity.pubUserName}：
								</label>
								${activity.scacTitle}
							</div>
							<div class="mt5 gray-color">
								活动时间：${activity.scacDate}
							</div>
							<div class="mt5 gray-color">
								活动地点：${activity.scacPlace}
							</div>
							<div class="ask-details mt5">
								...
								<div class="fr">
									<label class="mr15">
										<a href="javascript:void(0);" class="blue-front">回复(${activity.replyNum})</a>
									</label>
									|
									<label class="ml15 mr15">
										<a href="javascript:void(0);" class="blue-front">推荐(${activity.recommendNum})</a>
									</label>
									|
									<label class="ml15 mr15">
										<a href="javascript:void(0);" class="blue-front">收藏(${activity.favoriteNum})</a>
									</label>
									|
									<label class="ml15">
										<a href="javascript:void(0);" class="blue-front">删除</a>
									</label>
								</div>
							</div>
							<!-- 回复的线 -->
						  <c:if test="${not empty activity.snsCoreReplyInfos}">
						  	<div class="ask-line"></div>
						  </c:if>
							<!-- 回复内容  -->
						  <c:forEach var="replyData" items="${activity.snsCoreReplyInfos}">
							<div class="ask-user">
								<div class="fl">
									<img src="${ctx}/AUTO/SNS/static/images/xcr/user-photo.png" width="40px" height="40px"/>
								</div>
								<div class="fl ask-content">
									<div>
										<label class="blue-color fb">
											${replyData.pubUserName}：
										</label>
										${replyData.scriContent}
									</div>
									...
									<div class="fr">
										...
										|
										<label class="ml15">
											<a href="javascript:void(0);" class="blue-front reply-btn">回复</a>
										</label>
									</div>
									<div class="cb"></div>
									<div class="ask-for-box fr mt5 none">
											<input type="text" class="ui-input-text" style="width:345px;" /> 
											<div style="margin-top:7px;">
												<div class="fl"><a href=" javascript:void(0);"><img src="${ctx}/AUTO/SNS/static/images/xcr/smile-ico.png" /></a></div>
												<div class="send-btn fr"><a href="javascript:void(0);">发送</a></div>
												<div class="cb"></div>
											</div>
									</div>
								</div>
