...
<!--	填写消息	-->	
	    <table>
			<tr>
                ...
                <td>
                	<div>
						<input id="messagePersonS" name="messagePersonS" class="mini-lookup" style="width:200px;" 
...
<!--	发送按钮	-->
	<div>
		<a onclick="doSaveMessage()" class="release-btn fr"></a>
	</div>
<!--	发送按钮	 end-->
</div>
<script type="text/javascript">
	...
	function doSaveMessage(){
        var form = new mini.Form("#addMessageForm");
