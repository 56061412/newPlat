	...
	<body>
		<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    ...
		    <div showHeader="false" region="west" width="181" maxWidth="250" minWidth="100" >
		    	<iframe id="treeFrame" src="${ctx}/AUTO/OA/MENU/menuRoleTree.jsp" frameborder="0" name="treeFrame" style="width:100%;height:100%;" border="0"></iframe>
		    </div>
		    <!-- 主内容 -->
		    <div title="center" region="center" bodyStyle="overflow:hidden;" style="border:0;">
		        <iframe id="menuRoleFrame" src="" frameborder="0" name="menuRoleFrame" style="width:100%;height:100%;" border="0"></iframe>
		    </div>
		</div>
