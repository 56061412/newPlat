...
function onNodeSelect(e){
	...
	node.isLeaf = false;
	tree.loadNode(node);
	var orgInfoFrame = $('#orgInfoFrame', parent.document);
	var initJsonSearch = "{\"auorgParentGuid\":\""+node.auorgGuid+"\"}";   //序列化成JSON
	$(orgInfoFrame).attr("src", "${ctx}/AUTO/OA/ORG/orgInfoList.jsp?initJsonSearch="+initJsonSearch);
}
</script>
</html>
