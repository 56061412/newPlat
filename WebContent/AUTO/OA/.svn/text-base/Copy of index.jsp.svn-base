...
<html>
	...
	<body>
		<form action="${ctx}/login/userLogout.action" method="post"></form>
		<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    <div class="header" region="north" style="width:100%;height:200px;" showSplit="false" showHeader="false">
...
<!--			    <div id="tabs1" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;"></div>-->
