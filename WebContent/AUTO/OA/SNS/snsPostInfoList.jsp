...
<!-- 				<input id="apmeParentGuid" name="apmeParentGuid" class="mini-textbox" /> -->
			...
			<div style="padding-bottom:5px;">
				<span class="form-label">帖子类型：</span><input class="mini-textbox" name="postType" vtype="maxLength:50" />
	        ...
	        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:380px;" 
				url="${ctx}/sns/queryPageListSNSPostInfo.action" idField="postGuid"
				allowResize="true" sizeList="[10,20,50,100]" pageSize="20" 
				allowCellEdit="true" allowCellSelect="true" multiSelect="true">
			    <div property="columns">
			        <div type="checkcolumn" width="5%"></div>
			        <div field="postType" width="15%" headerAlign="center" allowSort="true" align="center">
			        	帖子类型
			        	<input property="editor" class="mini-textbox" style="width:100%;" />
			        </div>
			        <div field="postCreater" width="15%" headerAlign="center" allowSort="true" align="center">
			        	发帖人
			        	<input property="editor" class="mini-textbox" style="width:100%;" />
			        </div>
			        <div field="extra1" width="15%" headerAlign="center" allowSort="true" align="center">
			        	单位
			        	<input property="editor" class="mini-textbox" style="width:100%;" />
			        </div>
...
function remove() {
    ...
    if (rows.length > 0) {
        if (confirm("确定删除选中记录？")) {
            ...
            var postGuid = ids.join(',');
            grid.loading("操作中，请稍后......");
           // var url = "${ctx}/rest/oaMenuInfo/deleteSNSPostInfo/"+apmeGuid;
            var url = "${ctx}/sns/deleteSNSPostInfo.action?postGuid=" +postGuid;
            $.ajax({
            	type: 'post',
                url: url,
